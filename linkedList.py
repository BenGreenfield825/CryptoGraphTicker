# Classes for making a circular doubly linked list used for navigating screens with the momentary buttons


class Node:
    def __init__(self, data=None):
        self.data = data
        self.previous = self  # a list with one node will point backwards and forwards to itself
        self.next = self


class CDLinkedList:  # Circular Doubly Linked List
    def __init__(self):
        self.head = None
        self.count = 0
